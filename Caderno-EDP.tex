...
Para \( k=1 \), vamos lembrar que \( u \in C^\infty \) e que todas derivadas de funções harmônicas são harmônicas, porque é só trocar a ordem das derivadas no laplaciano \( u_{x_1x_1x_i} = (u_{x_i})_{x_1x_1} \). Então, popedoms fazer a propriedade da média com a derivada.
\begin{align*}
