...
\]
fazendo integração por partes no primeiro termo. Por aproximação, $v$ suave pode ser substituída por $v \in H^1_0(U)$. Fazendo isso, a equação resultante faz sentido somente se $u \in H^1_0(U)$. Esse espaço foi escolhido para incorporar a condição de que $u=0$ em $\pu$. (\textbf{???} Por que $H^1_0$ e não outros $W^{1,p}_0$?)
...
\begin{enumerate}[(i)]
	...
	B[u,v] = (f,v)
	\] para toda $v \in H^1_0(U)$, em que $( , )$ denota o produto interno em $L^2(U)$.
\end{enumerate}
...
\begin{equation}
	...
	\end{cases}
\end{equation}
Em que $L$ tem a forma divergente e $f^i \in L^2(U)$ para todo $i$. Devido ao que foi explorado no fim do último capítulo, o lado direito está em $H^{-1}(U)$, o espaço dual de $H^1_0(U)$.
